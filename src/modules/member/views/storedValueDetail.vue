...
<script>
  export default {
    ...
    mounted () {
      ...
      this.backData.tn = data.tn
      this.backData.pe = data.pe
      this.backData.st = data.st
      this.backData.et = data.et
      this.backData.tt = data.tt
      this.backData.sc = data.sc
      this.backData.si = data.si
      this.backData.pw = data.pw
      this.backData.pn = data.pn
      this.backData.ps = data.ps
    ...
    methods: {
      ...
      goback: function () {
        ...
        let pe = this.backData.pe
        let st = this.backData.st
        let et = this.backData.et
        let tt = this.backData.tt
        let sc = this.backData.sc
        let si = this.backData.si
        let pw = this.backData.pw
        let tn = this.backData.tn
        let pn = this.backData.pn
        let ps = this.backData.ps

        this.$router.push({
          path: '/member/views/storedValueRule',
          query: {tn: tn, pe: pe, st: st, et: et, tt: tt, sc: sc, si: si, pw: pw, pn: pn, ps: ps}
        })
      },
    }
  }
